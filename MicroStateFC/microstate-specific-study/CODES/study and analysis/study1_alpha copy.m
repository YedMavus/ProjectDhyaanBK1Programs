%% CODE FOR alpha band case
%% CODE FOR Alpha band case: STUDY 1
clc; clear; close all;

%% ============================================================
% STUDY 1 — ALPHA MICROSTATE + GLOBAL wPLI ANALYSIS
%
% runMode:
%   'pilot2' -> 003S control + 013AR meditator
%   'full10' -> selected 5 controls + 5 meditators
%
% Pipeline:
%   load saved alpha subject templates
%   derive common 5 alpha templates
%   preprocess EEG: 0.5-45 Hz + CAR + 8-13 Hz + CAR
%   backfit using common alpha templates
%   compute:
%       Coverage_A-E
%       Duration_A-E
%       GlobalWPLI_A-E
%   statistics:
%       pilot2: within-subject permutation tests
%       full10: LMM Response ~ Stage*Group + (1|Subject)
%% ============================================================
...
outputRoot = fullfile('/Users/anatapmitra/Desktop/NSP project/Study1_Alpha_Results', runMode);
...
for s = 1:length(subjects)
    ...
    for st = 1:length(allStages)
        ...
        data2D = preprocess_alpha(data2D, Fs);
...
function data = preprocess_alpha(data, Fs)
