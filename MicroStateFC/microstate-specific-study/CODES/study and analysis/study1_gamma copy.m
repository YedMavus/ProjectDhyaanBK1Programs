%% CODE for gamma band case
%% CODE FOR Gamma band case: STUDY 1
clc; clear; close all;
...
outputRoot = fullfile('/Users/anatapmitra/Desktop/NSP project/Study1_Gamma_Results', runMode);
...
%% ============================================================
% 1. LOAD SUBJECT TEMPLATES AND DERIVE COMMON GAMMA TEMPLATES
%% ============================================================

fprintf('\nLoading saved gamma subject templates...\n');
...
for s = 1:length(subjects)
    ...
    if ~exist(templatePath, 'file')
        error('Missing gamma template file:\n%s', templatePath);
    end
...
fprintf('All gamma subject-template matrix: [%d x %d]\n', ...
    size(allSubjectTemplates,1), size(allSubjectTemplates,2));

fprintf('Deriving common K=5 gamma templates...\n');
...
fprintf('\nBackfitting and extracting gamma features...\n');
